...
<div class="single-post">
    ...
    <div class="post-content">
        ...
        <div class="bottom-info">
            <a href="<?php echo esc_url( get_permalink() ); ?>" rel="bookmark" title="" class="btn btn-primary pull-left"><?php esc_html_e('Read More','themoments'); ?> <i class="fa fa-angle-double-right"></i></a>
